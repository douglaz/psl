...
See the [[Rule Specification | Rule Specification]] for details.
Rules in Groovy can now be specified in additional ways. See [[Rule Specification in Groovy | Rule Specification in Groovy]].
